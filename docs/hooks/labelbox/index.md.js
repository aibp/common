(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/hooks/labelbox/index.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/hooks/labelbox/index.md":
/*!******************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/hooks/labelbox/index.md ***!
  \******************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      ...
      [
        "img",
        {
          "src": "http://wiki.baidu.com/download/attachments/991386920/image2019-11-29_19-9-8.png?version=1&modificationDate=1575025755000&api=v2",
          "width": "500"
        }
      ]
    ],
  ...
  "meta": {
    "title": "useLabelBox",
    "cols": 1,
    "filename": "docs/hooks/labelbox/index.md"
  },
  "toc": [
    "ul",
    [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "当前标注模式【'pan'、‘drawRect’、‘drawPolygon’】"
          ],
          [
            "td",
            "是"
        ...
        [
          ...
          [
            "td",
            "是否触发默认内在过滤，默认false，【内在过滤仅会对标注框是否超出图像区域进行过滤】"
          ],
          [
            "td",
            "否"
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "标识是否呈现选中态：目前仅支持最多一个标注的select:true为编辑态"
          ],
          [
            "td",
            "否"
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "changeType类型，如'add'、'delete'、'update'等"
          ],
          [
            "td",
            "string"
        ...
        [
          ...
          [
            "td",
            "event事件对象，针对鼠标事件有效，目前仅针对'hover'"
          ],
          [
            "td",
            "object"
        ...
        [
          ...
          [
            "td",
            "针对鼠标事件有效，目前仅针对'hover', {x: , y: }，注意：此处是基于图片中心的坐标"
          ],
          [
            "td",
            "object"
